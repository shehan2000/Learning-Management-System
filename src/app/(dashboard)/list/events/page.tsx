...
const renderRow = (item: EventList) => (
  ...
  >
    ...
    <td className="hidden md:table-cell">{new Intl.DateTimeFormat("en-US", { timeStyle: "medium" }).format(item.startTime)}</td>
    <td className="hidden md:table-cell">{new Intl.DateTimeFormat("en-US", { timeStyle: "medium" }).format(item.endTime)}</td>
    <td>
